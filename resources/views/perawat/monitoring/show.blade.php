...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                @if($monitoring->status=='berjalan' || $monitoring->status=='belum')
                <a href="{{ action('Perawat\KontrolController@create', [$monitoring->id]) }}" class="btn btn-primary btn-sm">Tambah Kontrol</a>
                @endif
            </div>
        </div>
            ...
            <table class="table table-bordered" id="datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ action('Perawat\KontrolController@show', $kontrol->id) }}" class="btn btn-info btn-xs active" role="button" aria-pressed="true">Detail Kontrol</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
