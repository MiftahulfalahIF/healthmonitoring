...
class PasienController extends Controller
{
    ...
    {
         $pasiens = Pasien::get();
         return view('perawat.pasien.index')->with('pasiens', $pasiens);
    }
    ...
    {
        $pasiens = Pasien::get();
        return view('perawat.pasien.create')->with('pasiens', $pasiens);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('Perawat\PasienController@index')->with ('msg', 'Data Berhasil Ditambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('perawat.pasien.edit')->with('pasien', $pasien);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->action('Perawat\PasienController@index')->with ('msg', 'Data Berhasil Diedit');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->action('Perawat\PasienController@index')->with('msg', 'Data berhasil dihapus');
    ...
    public function kontrol($id)
    {
        ...
        return view('perawat.pasien.kontrol')->with('kontrol', $kontrol);
    }
